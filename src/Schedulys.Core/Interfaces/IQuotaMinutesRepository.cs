...
public interface IQuotaMinutesRepository
{
    ...
    Task<QuotaMinutes?>                 GetByProfAsync(int profId, int jourCycle = 0, string? annee = null);
    Task<IReadOnlyList<QuotaMinutes>>   GetAllByProfAsync(int profId, string? annee = null);
